...
1. Тираж на порт-ветки (Ф4-паттерн) — отдельно по команде.
(Ф0-прицеп DONE+ЗАКОММИЧЕН 2026-07-19: old==state гейт зазеркален в irlights main WorldBlockChangeMixin (height-гейт + identity + invalidateChange), редактор собран на core 1.2, вызов проверен байтами в jar, рантайм-smoke чист; irlights dafbf39.)
