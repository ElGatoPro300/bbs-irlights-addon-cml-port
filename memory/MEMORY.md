...
- [project-camera-relative-light-migration](project-camera-relative-light-migration.md) — свет-SSBO -> camera-relative: ЗАВЕРШЁН — миграция + прецизион-фикс света + anchor-relative БЕЙК ТЕНЕЙ (2026-07-10, тени искажались на ~100k) закоммичены и портированы на все линии; всё in-game verified; открыто: VL-noise camera-locked, photon Modification-дрейф, DOF-якоря.
